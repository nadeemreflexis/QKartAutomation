...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        ...
        try {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//h4[contains(text(),'No products found')]")));
            return true;
        }
        catch (Exception e) {
            ...
            for (WebElement cell : gridContent) {
                if (productName.contains(cell.findElement(By.className("css-yg30e6")).getText())) {
                    ...
                    wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
                            String.format("//div[@class='MuiBox-root css-1gjj37g']/div[contains(text(),'%s')]", productName))));
                    return true;
                }
            }
