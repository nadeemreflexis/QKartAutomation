...
public class QkartSanity {
    ...
    public static Boolean TestCase01(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("Step Failure", "User Registration", status ? "PASS" : "FAIL");
            takeScreenshot(driver, "FailRegisterTestStep", "TestCase01");
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "FailLoginTestStep", "TestCase01");
            return false;
        }
    ...
    public static Boolean TestCase02(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("End TestCase", "Test Case 2: Verify user Registration : ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "FailUserRegisterTestStep", "TestCase02");
            return false;
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("TestCase 3", "Test Case Failure. Unable to search for given product",
                    "FAIL");
            takeScreenshot(driver, "FailForSearchProductTestStep", "TestCase03");
            return false;
        }
        ...
        if (searchResults.size() == 0) {
            ...
            takeScreenshot(driver, "FailForSearchResultTestStep", "TestCase03");
            return false;
        }
            ...
            if (!elementText.toUpperCase().contains("YONEX")) {
                logStatus("TestCase 3",
                        "Test Case Failure. Test Results contains un-expected values: "
                                + elementText,
                        "FAIL");
                takeScreenshot(driver, "FailTitleSearch", "TestCase03");
                return false;
            }
        }
        ...
        if (!status) {
            logStatus("TestCase 3", "Test Case Failure. Unable to search for given product",
                    "FAIL");
            takeScreenshot(driver, "FailTestStepForWrongProductName", "TestCase03");
            return false;
        }
    ...
    public static Boolean TestCase04(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("End TestCase 4", "Test Case PASS. Validated Size Chart Details", "PASS");
    ...
    public static Boolean TestCase05(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "FailUserRegistrationTestStep", "TestCase05");
        }
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
            takeScreenshot(driver, "FailLoginTestStep", "TestCase05");
        }
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        login.navigateToLoginPage();
        login.PerformLogin(registration.lastGeneratedUsername, "abc@123");
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            logStatus("End TestCase",
                    "Test Case 8: Verify that insufficient balance error is thrown when the wallet balance is not enough: ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "FailUserRegistrationTestStep", "TestCase08");
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
        ...
        if (!status) {
            ...
            logStatus("End TestCase",
                    "Test Case 8: Verify that insufficient balance error is thrown when the wallet balance is not enough: ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "FailLoginTestStep", "TestCase08");
        }
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("Start TestCase", "Test Case 9: Verify added cart product in new tab", "DONE");
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Registration Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase", "Test Case 9: Verify added cart product in new tab ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "FailUserRegistrationTestStep", "TestCase09");
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
        ...
        if (!status) {
            ...
            logStatus("End TestCase", "Test Case 9: Verify added cart product in new tab  ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "FailLoginTestStep", "TestCase09");
        }
        ...
        logStatus("End TestCase",
                "Test Case 09:  Ensure that the cart contents are present in new tab ",
                status ? "PASS" : "FAIL");
    ...
    public static Boolean TestCase12(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("Step Pass", "Verify that 3 Advertisements are available",
                status ? "PASS" : "FAIL");

        WebElement advertisement1 = driver
                .findElement(By.xpath("//div[contains(@class,'MuiGrid-container')]/iframe[1]"));
        driver.switchTo().frame(advertisement1);
        driver.findElement(By.xpath("//button[text()='Buy Now']")).click();
        driver.switchTo().parentFrame();
        status = !driver.getCurrentUrl().equals(currentURL);
        logStatus("Step Pass", "Verify that Advertisement 1 button is clickable ",
                status ? "PASS" : "FAIL");

        driver.get(currentURL);
        Thread.sleep(3000);

        WebElement advertisement2 = driver
                .findElement(By.xpath("//div[contains(@class,'MuiGrid-container')]/iframe[2]"));
        driver.switchTo().frame(advertisement2);
        driver.findElement(By.xpath("//button[text()='Buy Now']")).click();
        driver.switchTo().parentFrame();
        status = !driver.getCurrentUrl().equals(currentURL);

        logStatus("Step Pass", "Verify that Advertisement 2 button is clickable ",
                status ? "PASS" : "FAIL");
